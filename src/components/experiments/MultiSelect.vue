...
<template>
  <div class="flex flex-row w-1/2">
    <div
      class="flex flex-row grow bg-white rounded-md border-gray-200 border-2 hover:border-blue-600 transition-all py-2">
      <div class="flex flex-col w-full flex-wrap px-2 gap-y-2 justify-center">
        <div class="flex flex-row w-full">
          <input v-model="inputValue" @keydown.enter="addFilter()" class="flex outline-none w-full"
        ...
        <div v-if="filters.length" class="flex flex-wrap gap-x-2 gap-y-2 border-t-2 border-gray-200 pt-2">
